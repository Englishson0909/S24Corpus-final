...
4.	Data analysis, Reporting results, data visualization 
RQ1 
Data Analysis 
Reporting results
Data visualization 
...
RQ2 
Null Hypothesis (H0): The distributional patterns of "very" as an adverb and adjective are independent of the type of text (Spoken: TED, Written: COCA).
